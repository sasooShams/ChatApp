...
public class ChatActivity extends Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            button_send_chat.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String A = editText_mail_id.getText().toString();
                    String B = editText_chat_message.getText().toString();
                    String F = Util.send_chat_url;

                    new SendMessage().execute(A,B,F);
        ...
        private void showChat(String type, String message){
            ...
            ChatAdaptor chatAdabter=new ChatAdaptor(ChatActivity.this,R.layout.chat_view,chat_list);
        ...
        private class SendMessage extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                String url = params[2]+"?email_id=" + params[0] + "&message="+ params[1];
