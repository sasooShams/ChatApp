...
public class GCMstart extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gcmstart);
        ...
        if(isUserRegistered(context)){
            ...
            startActivity(new Intent(GCMstart.this,ChatActivity.class));
            finish();
        ...
        new AsyncTask() {
            ...
            protected String doInBackground(Object[] params) {
                ...
                try {
                    ...
                    if (gcm == null) {
                        gcm = GoogleCloudMessaging.getInstance(GCMstart.this);
                    }
    ...
    private SharedPreferences getGCMPreferences(Context context) {
        ...
        return getSharedPreferences(GCMstart.class.getSimpleName(),
    ...
    private void sendRegistrationIdToBackend() {
        ...
        String a = editText_user_name.getText().toString();
        String b = editText_email.getText().toString();
        String c = regid;
        String d = Util.register_url;

        new SendGcmToServer().execute(a,b,c,d);
...
// Access the RequestQueue through your singleton class.
    ...
    private class SendGcmToServer extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String url = D + "?name"+a+"&email"+b+"&regId="+C;
          ...
          // String url = Util.register_url+"?name="+editText_user_name.getText().toString()+"&email="+editText_email.getText().toString()+"&regId="+regid;
           ...
           // String response=Util.callhttpRequest(url);
